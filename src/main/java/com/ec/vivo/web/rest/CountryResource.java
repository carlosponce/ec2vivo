...
import com.ec.vivo.repository.CountryRepository;
...
/**
 * REST controller for managing {@link com.ec.vivo.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public Mono<ResponseEntity<Country>> createCountry(@RequestBody Country country) throws URISyntaxException {
        ...
        return countryRepository.save(country)            .map(result -> {
                try {
    ...
    public Mono<ResponseEntity<Country>> updateCountry(@RequestBody Country country) throws URISyntaxException {
        ...
        return countryRepository.save(country)            .switchIfEmpty(Mono.error(new ResponseStatusException(HttpStatus.NOT_FOUND)))
