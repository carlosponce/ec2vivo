...
/**
 * REST controller for managing {@link com.ec.vivo.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public Mono<ResponseEntity<Location>> createLocation(@RequestBody Location location) throws URISyntaxException {
        ...
        return locationRepository.save(location)            .map(result -> {
                try {
    ...
    public Mono<ResponseEntity<Location>> updateLocation(@RequestBody Location location) throws URISyntaxException {
        ...
        return locationRepository.save(location)            .switchIfEmpty(Mono.error(new ResponseStatusException(HttpStatus.NOT_FOUND)))
